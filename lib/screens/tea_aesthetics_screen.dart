...
/// 茶道美学 — editorial gallery of the four aesthetic concepts (和敬清寂).
class TeaAestheticsScreen extends StatelessWidget {
  const TeaAestheticsScreen({super.key});
      ...
      body: SafeArea(
        ...
        child: ListView(
          ...
          children: [
            ...
            Text('于一席茶间,体味东方生活美学的四重境界。', style: AppTypography.body),
